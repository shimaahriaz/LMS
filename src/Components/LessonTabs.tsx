              ...
              {!hasVideoStarted ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-500 text-sm mb-4">
                    You need to start playing the video before you can add
                    notes. Notes are automatically timestamped to the current
                    video position.
                  </p>
                ...
                <>
                  <div className="flex space-x-2">
                    <input
                      ...
                      onKeyPress={(e) =>
                        e.key === "Enter" && hasVideoStarted && addNote()
                      }
                    />
                    <button
                      onClick={addNote}
                      ...
                      title={
                        !hasVideoStarted
                          ? "Start the video first to add notes"
                          : ""
                      }
                    >
                      Add
